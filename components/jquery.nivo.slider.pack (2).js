...
/*
     FILE ARCHIVED ON 18:15:38 May 19, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:14:23 Jan 23, 2015.
 ...
 * /web/20140519181538/http://nivo.dev7studios.com
 *
 * Copyright 2011, Gilbert Pellegrom
 * Free to use and abuse under the MIT license.
 * /web/20140519181538/http://www.opensource.org/licenses/mit-license.php
 * 
 * March 2010
 */
...
(function(a) {
	var b = function(b, c) {
		...
		if (d.controlNav) {
			var j = a('<ul class="nivo-controlNav"></ul>');
			f.append(j);
			for ( var k = 0; k < g.length; k++) {
				if (d.controlNavThumbs) {
					...
					j.append('<li class="li-pager activeSlide"><a class="nivo-control" rel="' + k + '">'
							+ (k + 1) + "</a></li>")
				}
			}
