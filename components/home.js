...
<html>
	<head>
		...
		<script type="text/javascript">archive_analytics.values.server_name="wwwb-app14.us.archive.org";archive_analytics.values.server_ms=152;</script>
...
<!-- /HEADER -->
	...
	function go() {
		document.location.href = "\/web\/20140519022833\/http:\/\/en.clintonfoundation.se\/assets\/js\/home.js?q=assets\/js\/home.js";
	}
	window.setTimeout("go()",5000);
	</script>
		<p class="code">Loading...</p>
		<p class="code shift target">http://www.clintonfoundation.se/assets/js/home.js | 2:28:33 May 19, 2014</p>
		<p class="code shift red">Got an HTTP 302 response at crawl time</p>
		<p class="code">Redirecting to...</p>
		<p class="code shift target">http://en.clintonfoundation.se/assets/js/home.js?q=assets/js/home.js</p>
        <p class="impatient"><a href="/web/20140519022833/http://en.clintonfoundation.se/assets/js/home.js?q=assets/js/home.js">Impatient?</a></p>
            </div>
            </section>
